...
#'}
#' @export
micro_global <- function(loc = "Madison, Wisconsin USA", decade = 1, model="gfdl", rcp="common", timeinterval = 12,
  ...
  fail = nyears * 24 * 365, TAI = 0, snowcond = 0, intercept = maxshade / 100 * 0.4, grasshade = 0) {
  ...
  if(errors==0){ # continue
    ...
    global_climate<-raster::brick(paste(Sys.getenv("AZ_BATCH_NODE_STARTUP_DIR"), "/wd","/global_climate_", model, "_", gcm, "_", decade,".nc",sep=""))
