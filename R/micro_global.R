...
#'}
#' @export
micro_global <- function(loc = "Madison, Wisconsin USA", decade = 1, model="gfdl", timeinterval = 12,
  ...
  if(errors==0){ # continue
    ...
    global_climate<-raster::brick(paste(Sys.getenv("AZ_BATCH_NODE_STARTUP_DIR"), "/wd","/global_climate_", model, "_", decade,".nc",sep=""))
